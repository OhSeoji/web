...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/web")
}
...
MIGRATION_MODULES = {"sites": "web.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "web.utils.context_processors.settings_context",
            ],
        },
    }
]
